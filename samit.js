const properties = [
    { id: 1, name: "Sky Dandelions Apartment", price: 11000, rating: 4.5, location: "Downtown", reviews: 120, image: './images/sky_dandelions_apartment.jpg' },
    { id: 2, name: "Village Tower", price: 9000, rating: 4.2, location: "Suburb", reviews: 85, image: './images/village_tower.jpg' },
    { id: 3, name: "Westside Modern House", price: 10000, rating: 4.7, location: "Westside", reviews: 150, image: './images/westside_modern_house.jpg'}
];
...
function showPropertyList() {
    ...
    filteredProperties.forEach(property => {
        ...
        propertyItem.innerHTML = `
            <img src="${property.image}" alt="${property.name}" class="property-image" onerror="this.src='./images/placeholder.jpg'">
...
function sortProperties(criteria) {
    switch(criteria) {
        ...
        case 'rating':
            ...
            break;
        case 'reviews':
            filteredProperties.sort((a, b) => b.reviews - a.reviews);
            break;
    }
    showPropertyList();
}